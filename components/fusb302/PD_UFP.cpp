...
#define PIN_OUTPUT_ENABLE       27 //GPIO27 //11 // GPIO35
// #define PIN_FUSB302_INT         36 // GPIO36
...
void PD_UFP_core_c::init(enum PD_power_option_t power_option, uint8_t interrupt_pin)
{
    PIN_FUSB302_INT = interrupt_pin;
...
{
    // Initialize FUSB302
    pinMode(PIN_FUSB302_INT, INPUT_PULLUP); // Set FUSB302 int pin input and pull up
